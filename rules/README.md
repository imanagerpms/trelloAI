...
| [interazione-clienti.md](interazione-clienti.md) | Telegram staff + futuro AIBridge chat ospiti |

Config strutturata (strutture, pesi, board): cartella [`../config/`](../config/).
